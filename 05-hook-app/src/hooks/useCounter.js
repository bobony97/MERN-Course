...
export const useCounter = ( initialValue = 10 ) => {  //La persona envia el valor inicial por el argumento, caso contrario este valor sera de "10"
    ...
    const increment = (value = 1) => {     //Si queremos que el numero no se incremente de 1 en 1, podemos enviarle un parametro para que el usuario determine de cuanto se va a incrementar
